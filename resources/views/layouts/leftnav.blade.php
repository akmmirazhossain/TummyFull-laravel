<ul class="menu menu-md bg-base-200 rounded-box ">
    <li>
        <h2 class="menu-title font-normal uppercase">Analytics</h2>
        <ul>
            <li><a href="{{ route('dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                    ...
                    Dashboard</a></li>
            <li><a href="{{ route('order_list') }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                        <path
    ...
    <li>
        <h2 class="menu-title font-normal uppercase">Wallet</h2>
        <ul>
            <li><a href="{{ route('wallet-recharge') }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#D7D7D7">
                        <path
            ...
            <li><a href="{{ route('wallet-recharge-history') }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#D7D7D7">
                        <path
    ...
    <li>
        <h2 class="menu-title font-normal uppercase">Chef</h2>
        <ul>
            <li><a href="{{ route('chef-list') }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                    ...
                    Chef List</a></li>
            <li><a href="{{ route('chef-payment-list') }}"><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    Chef Payment List </a></li>
            <li><a href="{{ route('chef-payment-history') }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#D7D7D7">
                        <path
                            d="M480-120q-138 0-240.5-91.5T122-440h82q14 104 92.5 172T480-200q117 0 198.5-81.5T760-480q0-117-81.5-198.5T480-760q-69 0-129 32t-101 88h110v80H120v-240h80v94q51-64 124.5-99T480-840q75 0 140.5 28.5t114 77q48.5 48.5 77 114T840-480q0 75-28.5 140.5t-77 114q-48.5 48.5-114 77T480-120Zm112-192L440-464v-216h80v184l128 128-56 56Z" />
                    </svg>
                    ...
                    Chef Payment History </a></li>

        </ul>
    </li>

    <li>
        <h2 class="menu-title font-normal uppercase">USERS</h2>
        <ul>
            <li><a href="{{ route('user_list') }}"><svg xmlns="http://www.w3.org/2000/svg" height="24px"
                        viewBox="0 -960 960 960" width="24px" fill="#e8eaed">
                        <path
    ...
    <li>
        <h2 class="menu-title font-normal uppercase">MONITOR</h2>
        <ul>
            <li><a href="{{ route('notif-list') }}">
